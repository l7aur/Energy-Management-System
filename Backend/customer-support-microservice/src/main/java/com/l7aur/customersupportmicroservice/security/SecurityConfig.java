package com.l7aur.customersupportmicroservice.security;

import com.l7aur.customersupportmicroservice.model.util.Role;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(
                        request -> request
                                .requestMatchers("/v3/api-docs/**", "/swagger-ui.html", "/swagger-ui/**", "/ws").permitAll()
